...
*/
export const fetchFirestoreProducts = async (path="", page=0, LIMIT=10, LAST_NODES=[], filter={}) => {
    ...
    try {
        ...
        if(queryPaths.length > 1){
            ...
            console.log('2: Fetched Firestore products for path -> ', path, '--->', res);
...
export const fetchFirestoreProduct = async (sku) => {
    ...
    try {
        ...
        console.log('fetchFirestoreProduct:response', res);
    }catch(err){
