...
const FAQS = [
    ...
    },
    {
        ...
        a: <Fragment>
                <p>
                    When you like or dislike an item Likebox get’s a better understanding of your individual preferences, in the same way that a person shopper would do. This information is what we use to ensure that you’re only shown items that you will love.
                </p>
            </Fragment>
    },
    {
        ...
        a: <Fragment>
                <p>
                    Our list of brands is constantly expanding and we’re always opening to hearing what our customers want so if you have a brand that you’d like to see on Likebox then email us at <a href="mailto:hello.likebox@gmail.com">hello.likebox@gmail.com</a>
                </p>
            </Fragment>
    },
    {
        ...
        a: <Fragment>
                ...
                <p>
                    We advise that you swipe through at least 30 products during the sign-up, however you can always come back to this later.
                </p>
                <p>
