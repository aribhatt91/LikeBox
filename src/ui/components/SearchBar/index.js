...
import { fetchSuggestions, saveSeachHistory, fetchSearchHistory } from '../../../libs/SearchService';
...
const SearchBar = (props) => {
    ...
    _search = () => {
      window.loginfo('Searching for ', search_term.trim());
      setShowSuggestions(false);
      if(search_term.trim() !== ""){
        //window.loginfo('Searching for ', search_term);
      }
    }
