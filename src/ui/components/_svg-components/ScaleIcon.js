...
export default function ScaleIcon({size=24}) {
    return (
        <span className="svg-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} version="1.1" viewBox="0 0 512.025 512.025" style={{enableBackground: 'new 0 0 512.025 512.025'}}>
            <g>
                <g>
                    <g>
