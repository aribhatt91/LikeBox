    ...
    return (<div className="container mb-5 mt-5">
        <section className="likebox-home-section section-clothes mb-5">
            ...
            <div className="staggered-grid clothes-grid row ml-0 mr-0">
                ...
                <div className="col-xs-12 col-md-6 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={menshoodiessweatshirts} />
                ...
                <div className="col-xs-12 col-md-4 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensjeans} />
                        <h3>Jeans</h3>
                ...
                <div className="col-xs-12 col-md-4 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensshorts} />
                        <h3>Shorts</h3>
                ...
                <div className="col-xs-12 col-md-4 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensscarves} />
                        <h3>Scarves</h3>
                ...
                <div className="col-xs-12 col-md-6 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensshirts} />
                        <h3>Shirts</h3>
                ...
                <div className="col-xs-12 col-md-6 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensjacketscoats} />
                        <h3>Jackets & Coats</h3>
        ...
        <section className="likebox-home-section section-clothes mb-5">
            ...
            <div className="staggered-grid clothes-grid row ml-0 mr-0">
                <div className="col-xs-12 col-md-7 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensboots} />
                        <h3>Boots</h3>
                ...
                <div className="col-xs-12 col-md-5 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={menssandals} />
                ...
                <div className="col-xs-12 col-md-5 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={menstrainers} />
                        <h3>Trainers</h3>
                ...
                <div className="col-xs-12 col-md-7 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensslippers} />
                        <h3>Slippers</h3>
                ...
                <div className="col-xs-12 col-md-12 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensshoes} />
                        <h3>All shoes</h3>
        ...
        <section className="likebox-home-section section-clothes">
            ...
            <div className="staggered-grid clothes-grid row ml-0 mr-0">
                <div className="col-xs-12 col-md-7 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensbelts} />
                        <h3>Belts</h3>
                ...
                <div className="col-xs-12 col-md-5 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={menscaps} />
                        <h3>Caps & hats</h3>
                ...
                <div className="col-xs-12 col-md-5 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensbags} />
                        <h3>Bags</h3>
                ...
                <div className="col-xs-12 col-md-7 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={mensgloves} />
                        <h3>Gloves</h3>
                ...
                <div className="col-xs-12 col-md-12 grid-item position-relative">
                    <div className="position-relative">
                        <LazyLoadImage className="grid-img" src={accessories} />
